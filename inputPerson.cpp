//
// inputPerson - create object of class Person and display their data
//
...
{
	// keep going untill operator say he's done or
	// untill we're out of space
...
// displayPeople - display an array of Person objcts
...
// 			 	by Social Secuirty Number (this uses a
//              binary sort)

void sortPeople(Person people[], int nCount)
{
	// keep going untill the list is in order
	int nSwaps = 1;
	while (nSwaps != 0)
	{
		// we can tell if the list is order by
...
int main(int nNumberofArgs, char* pszArgs[])
{
	...
	// prompt the user for inputPerson
