//
// factorialFunction - rewrite the factorial code as a separate function.
//
...
//			   Returns a 1 for invalid arguments such as
// 			   negative numbers.

int factorial (int nTarget)
{
	// start with an accumulato that's initialized to 1
	int nAccumulator = 1;
